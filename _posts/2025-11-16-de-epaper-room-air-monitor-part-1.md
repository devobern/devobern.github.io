...
## Das Warum
In der Zeit, in der die Fenster häufig geschlossen bleiben, wird die Luft schnell «dick». Die Luftfeuchtigkeit sowie der CO₂-Gehalt steigen. CO₂ wird in «parts per million» (ppm) gemessen – also in «Teilen CO₂ pro eine Million Luftmoleküle». So lässt sich gut vergleichen, wie stark die Innenraumluft im Vergleich zur Aussenluft mit CO₂ angereichert ist. Bei erhöhten Werten können folgende Probleme auftreten:
...
**Quelle:** ASHRAE (2022). *ASHRAE Position Document on Indoor Carbon Dioxide* – <a href="https://www.svlw.ch/images/aktuell/2022/pd_indoorcarbondioxide_2022.pdf" target="_blank" rel="noopener noreferrer">PDF</a>
...
**Quelle:** 
Wang, W., Zhang, X., & Li, W. (2023). *Effects of indoor humidity on human health and comfort: A systematic review*. Building and Environment – <a href="https://www.sciencedirect.com/science/article/pii/S2352710223002188" target="_blank" rel="noopener noreferrer">Artikel</a>
...
<a href="{{ '/assets/images/blog/2025-11-16/E-Paper-Raumluft-Monitor-MVP.jpg' | relative_url }}" target="_blank">
  <img src="{{ '/assets/images/blog/2025-11-16/E-Paper-Raumluft-Monitor-MVP.jpg' | relative_url }}" alt="M5Paper E‑Paper‑Gerät" />
</a>
...
<a href="{{ '/assets/images/blog/2025-11-16/dashboard_1.png' | relative_url }}" target="_blank">
  <img src="{{ '/assets/images/blog/2025-11-16/dashboard_1.png' | relative_url }}" alt="Dashboard All-in one Graph" />
</a>
<a href="{{ '/assets/images/blog/2025-11-16/dashboard_2.png' | relative_url }}" target="_blank">
  <img src="{{ '/assets/images/blog/2025-11-16/dashboard_2.png' | relative_url }}" alt="Dashboard tägliche Lüftungsanzahl und Minuten über Warnschwelle (Feuchte & CO2)" />
</a>
<a href="{{ '/assets/images/blog/2025-11-16/dashboard_3.png' | relative_url }}" target="_blank">
  <img src="{{ '/assets/images/blog/2025-11-16/dashboard_3.png' | relative_url }}" alt="Dashboard Minuten über kritischer Schwelle (Feuchte & CO2) und Minuten unter Warnschwelle (Feuchte & CO2)" />
</a>
...
<a href="{{ '/assets/images/blog/2025-11-16/telegram_bot_message.png' | relative_url }}" target="_blank">
  <img src="{{ '/assets/images/blog/2025-11-16/telegram_bot_message.png' | relative_url }}" alt="Nachricht des Telegram Bots" />
</a>
